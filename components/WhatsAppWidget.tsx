...
export const WhatsAppWidget: React.FC = React.memo(() => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center justify-center">
      ...
      <button
        onClick={handleClick}
        className="relative bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:bg-[#20bd5a] transition-all duration-300 hover:scale-110 flex items-center justify-center group"
